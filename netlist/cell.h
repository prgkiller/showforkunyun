...
class Cell: public std::enable_shared_from_this<Cell> {
    ...
    private:
        ...
        std::unordered_map<WIRE_NAME, std::shared_ptr<Wire>, StringCaseInsensitiveHash, StringCaseInsensitiveEqual> _wires;
    ...
    public:
        ...
        std::unordered_map<WIRE_NAME, std::shared_ptr<Wire>, StringCaseInsensitiveHash, StringCaseInsensitiveEqual>& GetWires();
        ...
        std::shared_ptr<Wire> FindWire(const WIRE_NAME& name) const;

        bool AddDevice(const std::shared_ptr<Device>& device);
        std::shared_ptr<Wire> DefineWire(const WIRE_NAME& wire);
