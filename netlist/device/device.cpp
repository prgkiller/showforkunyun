...
std::vector<std::pair<std::shared_ptr<Wire>, PIN_MAGIC>>& Device::GetConnectWires() {
    return _connectWires;
}

void Device::AddConnectWire(const std::shared_ptr<Wire>& wire, const PIN_MAGIC& pinMagic) {
